WITH in_scope AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.ea_pi_epic_in_scope
), corp_pi AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_litheo_corp_pis 
), epic_id_mapping AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.epic_id_mapping
), jira_pi_epic AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_jira_pi_epic
    ...
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_aha_features_pi_planning
    ...
    SELECT * FROM AV_EDM_DEV.ABAGDI_ENG_ANALYTICS.workitem
), pi_workitem AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_ENG_ANALYTICS.pi_workitem
), pi_epic_workitem AS (
    SELECT 
        corp_pi_id
        ,epic_id
