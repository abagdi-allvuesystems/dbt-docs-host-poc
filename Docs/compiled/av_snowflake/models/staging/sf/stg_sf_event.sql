WITH sf_event AS (
    ...
    FROM AV_EDM_DEV.ABAGDI_SYSTEM.sys_sf_event
),
...
sf_user AS (
    ...
    FROM AV_EDM_DEV.ABAGDI_SYSTEM.sys_sf_users
),
...
sf_contact AS (
    SELECT
        ...
        lastname,
        email
    FROM AV_EDM_DEV.ABAGDI_SYSTEM.sys_sf_contact
),
...
sf_lead AS (
    ...
    FROM AV_EDM_DEV.ABAGDI_SYSTEM.sys_sf_lead
),
...
sf_account AS (
    SELECT
        ...
        industry
    FROM AV_EDM_DEV.ABAGDI_SYSTEM.sys_sf_account
),
...
sf_opportunity AS (
    SELECT
        ...
        close_date
    FROM AV_EDM_DEV.ABAGDI_SYSTEM.sys_sf_opportunity
)
