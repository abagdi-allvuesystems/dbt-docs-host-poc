...
WITH dim_date AS (
    ...
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_openair_project_dates
), dim_oa_issues AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_openair_issue
), dim_oa_proj AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_openair_project
), dim_customer AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_SALES.dim_customer
