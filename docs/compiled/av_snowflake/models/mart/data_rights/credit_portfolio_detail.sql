WITH assets_fo_serv AS (
    ...
    FROM AV_EDM_DEV.ABAGDI_STAGING.dim_assets_ism_clientserv_frontoffice 
), credit_aum AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.product_credit_portfolio_data WHERE PARRC > 50.0
), assets_orgs AS (
