WITH dim_jira_ente_tickets AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_jira_enterprise_tickets
), dim_jira_cust_tickets_labels AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_jira_customer_tickets_labels
), dim_jira_cust_tickets_customers AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_STAGING.dim_jira_customer_tickets_customers
