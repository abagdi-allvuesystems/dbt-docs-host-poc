WITH assets_objects AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_SYSTEM.assets_objects
), asset_object_attributes AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_SYSTEM.assets_objects_attributes
), asset_objecttypes AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_SYSTEM.assets_objectschema_objecttypes
), asset_attributes AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_SYSTEM.assets_objectschema_attributes
), asset_object_attribute_values AS (
    SELECT * FROM AV_EDM_DEV.ABAGDI_SYSTEM.assets_objects_attributes_values
