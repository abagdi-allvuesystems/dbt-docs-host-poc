...
WITH jsm_acp_issues_recent AS (
    ...
    FROM AV_EDM_DEV.ABAGDI_SOURCE.ab_jsm_acp_issues
    ...
    FROM AV_EDM_DEV.ABAGDI_SOURCE.ab_jsm_acp_issues_2023
), iap AS (
       SELECT
        id::INT AS id
        ,key
        ...
        ,updated::TIMESTAMP_TZ AS sys_updated
        ,_airbyte_extracted_at::TIMESTAMP_TZ AS raw_updated
        FROM AV_EDM_DEV.ABAGDI_SOURCE.ab_jsm_iap_issues
), eim AS (
       SELECT
        id::INT AS id
        ,key
        ...
        ,updated::TIMESTAMP_TZ AS sys_updated
        ,_airbyte_extracted_at::TIMESTAMP_TZ AS raw_updated
        FROM AV_EDM_DEV.ABAGDI_SOURCE.ab_jsm_eim_issues
), jsm_issues_all AS (
    ...
    SELECT * FROM AV_EDM_DEV.ABAGDI_SOURCE.deleted_jira_issues
